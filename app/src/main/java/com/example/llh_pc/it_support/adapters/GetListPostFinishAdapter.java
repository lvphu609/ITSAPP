...
public class GetListPostFinishAdapter extends ArrayAdapter<LuuTruModel> {
    ...
    public GetListPostFinishAdapter(Context context, int resource, List<LuuTruModel> objects) {
